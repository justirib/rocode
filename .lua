...
--[[
	UPDATE 8
	----
	* Highlight system changes
		[-] Reverted Selection to render under text
		[+] Selection transparency is now [0.7]
		
	* Syntax Changes
		[+] Syntax color is now similar to Visual Studio Code Themes -> Github Dark Theme.
		
	* Formatting changes
		[+] Fixed SetText, GetText, and ConverText not converting tab characters to four spaces.
